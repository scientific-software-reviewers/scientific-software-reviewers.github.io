...
`}),e.add({id:6,href:"/docs/exercises/",title:"Exercises",description:"",content:""}),e.add({id:7,href:"/docs/exercises/ex_intro/",title:"Tutorial Exercises",description:"Exercises for code review",content:`There are three sets of exercises, all on GitHub. Follow the setup instructions to create your own tutorial repository to work on.
...
What makes a pull request easy to review? What makes a pull request difficult to review? `}),e.add({id:11,href:"/docs/exercises/tldr/",title:"TL;DR",description:"quick start",content:`For each exercise:
...
`}),e.add({id:12,href:"/docs/reviewing/reviewing/",title:"Reviewing",description:"Reviewing",content:`Software engineering is programming integrated over time [1]. The goal of code review is to be continually improving our code.
...
US-RSE. A community of people who make research software happen. Society of Research Software Engineering which emerged from the successful grass-roots RSE movement and is the successor to the UK RSE Association. Better Scientific Software. A hub for scientific software development resources. Campus Champions. Uniting Research Computing Facilitators `}),e.add({id:16,href:"/docs/help/",title:"Help",description:"Help with common code review tasks",content:""}),e.add({id:17,href:"/blog/",title:"Blog",description:"Collecting the good, bad, and ugly parts of code review",content:""}),e.add({id:18,href:"/docs/",title:"Tutorial",description:"An online tutorial for code review",content:""}),search.addEventListener("input",t,!0);function t(){const s=5;var n=this.value,o=e.search(n,{limit:s,enrich:!0});const t=new Map;for(const e of o.flatMap(e=>e.result)){if(t.has(e.doc.href))continue;t.set(e.doc.href,e.doc)}if(suggestions.innerHTML="",suggestions.classList.remove("d-none"),t.size===0&&n){const e=document.createElement("div");e.innerHTML=`No results for "<strong>${n}</strong>"`,e.classList.add("suggestion__no-results"),suggestions.appendChild(e);return}for(const[r,a]of t){const n=document.createElement("div");suggestions.appendChild(n);const e=document.createElement("a");e.href=r,n.appendChild(e);const o=document.createElement("span");o.textContent=a.title,o.classList.add("suggestion__title"),e.appendChild(o);const i=document.createElement("span");if(i.textContent=a.description,i.classList.add("suggestion__description"),e.appendChild(i),suggestions.appendChild(n),suggestions.childElementCount==s)break}}})()